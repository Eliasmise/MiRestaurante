...
const statusMap: Record<Status, { label: string; className: string }> = {
  ...
  ready: { label: "Ready", className: "bg-emerald-100 text-emerald-700 status-ready" },
  needs_payment: { label: "Payment", className: "bg-rose-100 text-rose-700 status-attention" },
